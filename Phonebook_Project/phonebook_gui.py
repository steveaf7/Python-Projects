...
def load_gui(self):
    ...
    # binding an event listener to our listbox, if the user selects on an object in the list,
    # it will call the function onSelect
    ...
    #Buttons (add, update, delete and close)
